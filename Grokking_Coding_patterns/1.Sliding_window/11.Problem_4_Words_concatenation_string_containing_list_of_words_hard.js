...
console.log(`Smallest Window containing Substring of given pattern: ${find_word_concatenation('catfoxcat', ['cat', 'fox'])}`);

console.log(`Smallest Window containing Substring of given pattern: ${find_word_concatenation('catcatfoxfox', ['cat', 'fox'])}`);
